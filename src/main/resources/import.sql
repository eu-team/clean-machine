...
insert  into machine_programs(machine_identifier, programs_id) values ('1',1);
insert  into machine_programs(machine_identifier, programs_id) values ('1',2);
insert  into machine_programs(machine_identifier, programs_id) values ('1',3);
...
INSERT INTO facility_machines (machines_identifier,facility_id)VALUES ('1', 1);
